...
class Mount_Pleasant(Airport):
    ...
    civilian = False
    slot_version = 2
    atc_radio = AtcRadio(hf_hz=4100000, vhf_low_hz=39100000, vhf_high_hz=133350000, uhf_hz=250700000)
...
class San_Carlos_FOB(Airport):
    ...
    civilian = False
    slot_version = 2
    atc_radio = AtcRadio(hf_hz=4125000, vhf_low_hz=39150000, vhf_high_hz=134350000, uhf_hz=250750000)
...
class Rio_Gallegos(Airport):
    ...
    civilian = False
    slot_version = 2
    atc_radio = AtcRadio(hf_hz=4150000, vhf_low_hz=39200000, vhf_high_hz=119100000, uhf_hz=250800000)
...
class Rio_Grande(Airport):
    ...
    civilian = False
    slot_version = 2
    atc_radio = AtcRadio(hf_hz=4175000, vhf_low_hz=39250000, vhf_high_hz=118300000, uhf_hz=250850000)
...
class Ushuaia(Airport):
    ...
    civilian = False
    slot_version = 2
    atc_radio = AtcRadio(hf_hz=4200000, vhf_low_hz=39300000, vhf_high_hz=118100000, uhf_hz=250900000)
...
class Ushuaia_Helo_Port(Airport):
    ...
    civilian = False
    slot_version = 2
    atc_radio = AtcRadio(hf_hz=4225000, vhf_low_hz=39350000, vhf_high_hz=118500000, uhf_hz=250950000)
...
class Punta_Arenas(Airport):
    ...
    civilian = False
    slot_version = 2
    atc_radio = AtcRadio(hf_hz=4250000, vhf_low_hz=39400000, vhf_high_hz=118700000, uhf_hz=251000000)
...
class Almirante_Schroeders(Airport):
    ...
    def __init__(self, terrain: Terrain) -> None:
        ...
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=12, position=mapping.Point(-209417.5625, -741759.5625, self._terrain), large=False, heli=True,
                airplanes=True, slot_name='A01', length=60.0, width=52.0, height=18.0, shelter=False))
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=13, position=mapping.Point(-209534.28125, -740958.875, self._terrain), large=False, heli=True,
        ...
        self.parking_slots.append(ParkingSlot(
                ...
                airplanes=False, slot_name='Stand01', length=42.0, width=34.0, height=14.0, shelter=False))
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=15, position=mapping.Point(-209873.234375, -740945.9375, self._terrain), large=False, heli=True,
                airplanes=False, slot_name='Stand02', length=42.0, width=34.0, height=14.0, shelter=False))
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=16, position=mapping.Point(-209839.90625, -740973.25, self._terrain), large=False, heli=True,
                airplanes=False, slot_name='Stand03', length=30.0, width=23.0, height=10.0, shelter=False))
        self.parking_slots.append(ParkingSlot(
                crossroad_idx=17, position=mapping.Point(-209834.109375, -740997.625, self._terrain), large=False, heli=True,
                airplanes=False, slot_name='Stand04', length=30.0, width=23.0, height=10.0, shelter=False))
